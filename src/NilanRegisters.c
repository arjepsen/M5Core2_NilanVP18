...
// static const nilan_reg_meta_t nilan_registers[NILAN_REGID_COUNT] = {
...
//     [NILAN_REGID_IR_APP_VERSION_MAJOR] = {
//         .addr = 1,
//         .reg_type = NILAN_INPUT_REG,
//         .data_type = NILAN_DTYPE_UINT16,
...
//     [NILAN_REGID_IR_APP_VERSION_MINOR] = {
//         .addr = 2,
//         .reg_type = NILAN_INPUT_REG,
//         .data_type = NILAN_DTYPE_UINT16,
...
//     [NILAN_REGID_TANK_TOP] = {
//         .addr = 211,
//         .func = 4,
//         .dtype = NILAN_DTYPE_TEMP_Cx100,
//         .name = "Tank top T11",
//     },
// }
...
const nilan_reg_meta_t nilan_registers[NILAN_REGID_COUNT] = {
    ...
    [NILAN_REGID_IR_APP_VERSION_MAJOR] = {
        .addr      = 1,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_UINT16,   // 2 ASCII chars packed
        .name      = "SW version - major"
    },
    ...
    [NILAN_REGID_IR_APP_VERSION_MINOR] = {
        ...
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_UINT16,   // 2 ASCII chars packed
        .name      = "SW version - minor"
    },

    [NILAN_REGID_IR_APP_VERSION_RELEASE] = {
        .addr      = 3,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_UINT16,   // 2 ASCII chars packed
        .name      = "SW version - release"
    },

    // -------------- 1xx Discrete inputs -------------------
    [NILAN_REGID_IR_INPUT_USERFUNC] = {
        .addr      = 100,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_UINT16,
        .name      = "User function"
    ...
    [NILAN_REGID_IR_T0_CONTROLLER] = {
        .addr      = 200,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "Controller board"
    },

    [NILAN_REGID_IR_T2_INLET] = {
        .addr      = 202,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "Inlet preheater"
    },
    ...
    [NILAN_REGID_IR_HUMIDITY] = {
        .addr      = 221,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_UINT16,   // 0..10000 => 0..100.00 %
        .name      = "Humidity"
    },

    // -------------- 4xx Alarm list ------------------------
    // 400 = alram state bit mask. 0x80: active alarms. 0x03: # of alarms
    [NILAN_REGID_IR_ALARM_STATUS] = {
        .addr      = 400,
        .reg_type  = NILAN_INPUT_REG,
    ...
    [NILAN_REGID_IR_CONTROL_RUNNING] = {
        .addr      = 1000,
        .reg_type  = NILAN_INPUT_REG,
    ...
    // -------------- 1100 Airflow (status) -----------------
    [NILAN_REGID_IR_AIRFLOW_VENT_SETPOINT] = {
        .addr      = 1100,
        .reg_type  = NILAN_INPUT_REG,
    ...
    // -------------- 1200 AirTemp (status) -----------------
    [NILAN_REGID_IR_AIRTEMP_SUMMER_STATE] = {
        .addr      = 1200,
        .reg_type  = NILAN_INPUT_REG,
    ...
    [NILAN_REGID_IR_CENTHEAT_HEAT_EXT_SETPOINT] = {
        .addr      = 1800,
        .reg_type  = NILAN_INPUT_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "External Heat Source Setpoint"
    },
    ...
    [NILAN_REGID_HR_OUTPUT_CEN_HEAT_EXT] = {
        ...
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_UINT16,
        .name      = "External radiator heating"
    },
    ...
    [NILAN_REGID_HR_PROGRAM_USER2_VENT_SET] = {
        ...
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_UINT16,
        .name      = "UserFunc2 vent step"
    },

    [NILAN_REGID_HR_PROGRAM_USER2_TEMP_SET] = {
        .addr      = 614,
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_INT16,
        .name      = "UserFunc2 temp"
    },
    ...
    [NILAN_REGID_HR_CONTROL_SERVICE_MODE] = {
        .addr      = 1005,
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_ENUM16,
        .name      = "Service mode"
    ...
    [NILAN_REGID_HR_CONTROL_SERVICE_PCT] = {
        .addr      = 1006,
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_UINT16,   // % *100
    ...
    [NILAN_REGID_HR_AIRTEMP_NIGHT_SET] = {
        ...
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "Night-cooling setpoint"
    },

    // -------------- 1700 HotWater settings ----------------
    [NILAN_REGID_HR_HOTWATER_TEMPSET_TOP_ELEC] = {
        .addr      = 1700,
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "Tank Top setpoint (elec.)"
    },

    [NILAN_REGID_HR_HOTWATER_TEMPSET_BOTTOM_COMPR] = {
        .addr      = 1701,
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "Tank Bottom setpoint (compr.)"
    },
    ...
    [NILAN_REGID_HR_CENTHEAT_HEAT_EXTERN] = {
        ...
        .reg_type  = NILAN_HOLDING_REG,
        .data_type = NILAN_DTYPE_TEMP_Cx100,
        .name      = "Ext. heat offset temp setpoint"
    },
